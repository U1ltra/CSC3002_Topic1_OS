...
public:
    ...
    /*
     * Return the data storing in the text box in the given position
     */
    QString getData(int row, int col);

    /*
     * Set the given number of culomn to be RGB corresponds to given
     * integer array
     */
    void setColor(int col, std::vector<int> * colors);
